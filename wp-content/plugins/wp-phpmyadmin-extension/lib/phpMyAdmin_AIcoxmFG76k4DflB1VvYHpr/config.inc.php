...
$cfg['blowfish_secret']					= 'X*U{^C+k3-q65sut@Q2;*cLfqXzeH\'m.' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/heat-pumps-wp/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_AIcoxmFG76k4DflB1VvYHpr/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
